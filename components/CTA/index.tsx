          ...
          <div className="flex flex-wrap gap-8 md:flex-nowrap md:items-center md:justify-between md:gap-0">
            ...
            >
              <h2 className="mb-4 w-11/12 text-3xl font-bold text-black dark:text-white xl:text-sectiontitle4">
                Join Us Today & Unlock Africa’s AI Potential
              </h2>
              <p className="text-lg text-gray-700 dark:text-gray-300">
                Be part of Generative Africa and take the first steps towards AI technologies. Together, we can empower communities, transform industries, and shape a future where Africa leads the way in creativity.
              </p>
            </motion.div>
            <motion.div
              variants={{
